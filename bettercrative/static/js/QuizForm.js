function refresh_and_set_session(section,question_id)
{
...
event.preventDefault();
    ...
    $.ajax({
        ...
        success: function() {
            ...
            refresh_and_set_session("#quiz-container", question_id);
...
* Param:
    question_id - can be question or answer id
* Return: 
    n/a
*/

function set_question_ide(question_id){
...
function destroy_session(id){
    console.log('destroying the session on question '+id);
